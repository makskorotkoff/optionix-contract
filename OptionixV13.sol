...
import {UD60x18, ud, convert, log10} from "@prb/math/src/UD60x18.sol";

/// @title OptionixV13
/// @dev  This contract is for handling trading operations and processingliquidity.
    ...
    UUPSUpgradeable
{
    ...
    mapping(address => LiquidityProviderBalance)
    ...
    function initialize() public initializer {
        ...
        LIQUIDITY_PROVIDERS_COMISSION = ud(0.06e18);
        MAXBET_COEF = 2;
        minBet = 0.005 ether;
    }
    ...
    function depositLiquidity() public payable whenNotPaused {
        require(msg.value > 0, "Zero value"); // value should be greater than zero
        require(
     ...
     */
    function withdrawOwnerComissions() external onlyOwner reentrancyGuard {
